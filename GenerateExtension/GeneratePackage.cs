//------------------------------------------------------------------------------
// <copyright file="GeneratePackage.cs" company="Microsoft">
...
namespace GenerateExtension
{
    ...
    public sealed class GeneratePackage : Package
    {
        ...
        /// </summary>
        public const string PackageGuidString = "da39d1de-4d6c-44b4-a7c4-14faaccb44b4";
        ...
        {
            base.Initialize();
            CommandGenerateEntity.Initialize(this);
            CommandAgentClass.Initialize(this);
        }
