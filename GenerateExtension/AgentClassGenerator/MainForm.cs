...
namespace GenerateExtension.AgentClassGenerator
{
    public partial class MainForm : Form
    {
        ...
        public SlnInfo sInfo { get; set; }

        public MainForm(SlnInfo sInfo)
        {
            this.sInfo = sInfo;
            CfgPath = sInfo.SlnPath;
        ...
        {
            string dirPath = Path.Combine(sInfo.SelectProjectDir, "AgentService");
            if (!Directory.Exists(dirPath))
            {
                Directory.CreateDirectory(dirPath);
            } 
            return Path.Combine(dirPath, appId + ".cs");
        }
